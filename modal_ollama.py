...
MODELS_TO_DOWNLOAD = ["phi3:mini", "mistral:7b"]  # Changed to lighter models
MODELS_TO_TEST = ["phi3:mini", "mistral:7b"]      # Changed to lighter models
...
app = modal.App("ollama-server2", image=ollama_image)
